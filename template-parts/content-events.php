 <div class="events">
     <div class="events__wrapper">
         ...
         <a class="events__button" href="<?php echo get_permalink(16); ?>">Всі
         ...
         <li class="events__item">
             ...
             <div class="events__description">
                 <div class="events__info">
                     <div class="events__category">
                         <svg width="24px" height="24px">
                             <use href="<?php bloginfo('template_url'); ?>/assets/images/symbol-defs.svg#icon-folder">
                             </use>
                         </svg>
                         <?php the_category(', '); ?>
                     </div>
                     <div class="events__date">
                         <svg width="24px" height="24px">
                             <use href="<?php bloginfo('template_url'); ?>/assets/images/symbol-defs.svg#icon-calendar">
                             </use>
                         </svg>
                         <?php the_field('date'); ?>
                     </div>
                 ...
                 <a href="<?php the_permalink(); ?>" class="events__link">Дізнатися Більше
                     <svg class="events__icon" width="24px" height="24px">
                         <use href="<?php bloginfo('template_url'); ?>/assets/images/symbol-defs.svg#icon-arrow">
                         </use>
                     </svg>
                 </a>
             </div>
