    ...
    <div class="sidebar__section">
        <div class="categories__header">
            ...
            <button type="button" class="categories-button"
                aria-label="Кнопка для розгортання, згортання меню катергорій">
...
$categories = get_categories(); ?>
            <li class="categories__item categories__item--contrast"><a href="<?php echo get_permalink(16); ?>">
                    <span>Всі</span>
                    <span
                        class="categories__count categories__count--contrast"><?php echo wp_count_posts()->publish; ?></span>
...
?>
    ...
    <div class="sidebar__section">
        <div class="latest-posts__header">
            ...
            <button type="button" class="latest-posts-button"
                aria-label="Кнопка для розгортання, згортання останніх постів">
                <svg width="24px" height="24px">
                    <use href="<?php bloginfo('template_url'); ?>/assets/images/symbol-defs.svg#icon-arrow"></use>
                </svg>
            </button>
                ...
                <div class="latest-posts__description">
                    ...
                    <div class="latest-posts__info">
                        <div class="latest-posts__category">
                            <svg width="24px" height="24px">
                                <use
                                    href="<?php bloginfo('template_url'); ?>/assets/images/symbol-defs.svg#icon-folder">
                                </use>
                            </svg>
                            <?php the_category(', '); ?>
                        </div>
                        <div class="latest-posts__date">
                            <svg width="24px" height="24px">
                                <use
                                    href="<?php bloginfo('template_url'); ?>/assets/images/symbol-defs.svg#icon-calendar">
                                </use>
                            </svg>
                            <?php the_field('date'); ?>
                        </div>
    ...
    <div class="sidebar__section">
        ...
        <div class="sidebar-donate sidebar__wrapp">
            <div class="sidebar-donate__img">
                <img src="<?php bloginfo('template_url'); ?>/assets/images/pov-woman-feeds-wild-horse 1.jpg"
                    alt="Жінка з рук кормить коня ">
            </div>
