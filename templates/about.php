        ...
        <div class="about__container">
                    ...
                    <div class="about-history__logo">
                        <div class="about-history__box">
                            <div class="about-history__img about-history__img--old ">
                                <img src="<?php bloginfo( 'template_url' ); ?>/assets/images/logo-old.svg"
                                     alt="Логотип Ореолі">
                            </div>
                        ...
                        <div class="about-history__box about-history__box--small">
                            <div class="about-history__img about-history__img--new ">
                                <img src="<?php bloginfo( 'template_url' ); ?>/assets/images/logo-new.svg"
                                     alt="Логотип з тавром">
                            </div>
            ...
            <section class="section container">
                <div class="about__section box about_museum">
                    ...
                    <a href="<?php echo get_permalink( 13 ); ?>"
                       class="about__link"><?php the_field( 'museum-button' ) ?>
            ...
            <section class="section container">
                <div class="about__section box about__horses">
                    ...
                    <a href="<?php echo get_permalink( 11 ); ?>"
                       class="about__link"><?php the_field( 'horses-button' ) ?>
                        <svg class="posts__icon" width="24px" height="24px">
                            <use href="<?php bloginfo( 'template_url' ); ?>/assets/images/symbol-defs.svg#icon-arrow"></use>
                        </svg>
                    </a>
            ...
            <section class="section container">
                <div class="about__section box about__nature">
                    ...
                    <a href="<?php echo get_permalink( 13 ); ?>"
                       class="about__link"><?php the_field( 'nature-button' ) ?>
                        <svg class="posts__icon" width="24px" height="24px">
                            <use href="<?php bloginfo( 'template_url' ); ?>/assets/images/symbol-defs.svg#icon-arrow"></use>
                        </svg>
                    </a>
                ...
                <div class="gallery-mob-wrapper">
                    <div class="section container">
                        <div class="about-gallery__container">
                            ...
                            <a class="about-gallery__button" target="_blank"
                               href="<?php echo esc_attr( get_field( 'instagram', 18 ) ); ?>"><?php the_field( 'gallery-button' ); ?>
                    ...
                    <div class="about-gallery__wrapper about-swiper container">
